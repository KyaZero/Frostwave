...
namespace DirectX
{
    ...
    namespace LoaderHelpers
    {
            ...
            size_t* bitSize)
        {
            ...
            if (fileInfo.EndOfFile.LowPart < (sizeof(DDS_HEADER) + sizeof(u32)))
            {
                return E_FAIL;
            }
            ...
            u32 dwMagicNumber = *reinterpret_cast<const u32*>(ddsData.get());
            if (dwMagicNumber != DDS_MAGIC)
            {
                return E_FAIL;
            }

            auto hdr = reinterpret_cast<const DDS_HEADER*>(ddsData.get() + sizeof(u32));
                ...
                (MAKEFOURCC('D', 'X', '1', '0') == hdr->ddspf.fourCC))
            {
                ...
                if (fileInfo.EndOfFile.LowPart < (sizeof(DDS_HEADER) + sizeof(u32) + sizeof(DDS_HEADER_DXT10)))
                {
                    return E_FAIL;
                }
            ...
            *header = hdr;
            ptrdiff_t offset = sizeof(u32) + sizeof(DDS_HEADER)
