...
#include <memory>
    ...
    #define MAKEFOURCC(ch0, ch1, ch2, ch3) \
                (static_cast<u32>(static_cast<uint8_t>(ch0)) \
                | (static_cast<u32>(static_cast<uint8_t>(ch1)) << 8) \
                | (static_cast<u32>(static_cast<uint8_t>(ch2)) << 16) \
                | (static_cast<u32>(static_cast<uint8_t>(ch3)) << 24))
...
namespace DirectX
{
    ...
    public:
        ...
        virtual const char* what() const override
        {
            ...
            sprintf_s(s_str, "Failure with HRESULT of %08X", static_cast<u32>(result));
            return s_str;
        }
